...
function openInstaNewWindow() {
	window.open("http://14.32.18.100:8081/test/AngularInstagram.jsp","인스타그램 인기사진","location=no, width=1000px, height=745px");
}
...
function attachButtons(buttons) {
	$('#buttons').html(buttons).promise().done(toTop());
}
